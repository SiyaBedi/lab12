...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("stupid"); //throw a TreeException with a useful message
		...
		else
		{
			...
			if(parentNode == null)
				throw new TreeException("ur dumb");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("this assignment is stupid"); //Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("this assignment is dumb"); //Throw TreeException with a useful message
